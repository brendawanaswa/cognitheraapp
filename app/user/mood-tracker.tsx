...
const FEELINGS = [
  "Anxious", "Calm", "Sad", "Happy", "Angry",
  "Grateful", "Lonely", "Hopeful", "Tired", "Motivated",
  "Overwhelmed", "Peaceful", "Frustrated", "Loved", "Confused",
];
...
const HISTORY = [
  { date: "Today, 8:00 AM",     mood: 5, feelings: ["Motivated", "Grateful"],  note: "Woke up feeling refreshed. Ready for the day!" },
  { date: "Yesterday, 9:30 PM", mood: 3, feelings: ["Tired", "Calm"],          note: "Long day but managed to wind down." },
  { date: "Mon, 7:45 AM",       mood: 2, feelings: ["Anxious", "Overwhelmed"], note: "Feeling a bit stressed about work." },
];
...
export default function MoodTracker() {
  ...
  const avgMood = (WEEK_DATA.reduce((a, b) => a + b.mood, 0) / WEEK_DATA.length).toFixed(1);
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.summaryCard}>
          ...
          <View style={styles.summaryTopRow}>
            <View>
              <Text style={styles.summaryMood}>{topMood?.emoji} {topMood?.label}</Text>
              ...
              return (
                <View key={d.day} style={styles.barCol}>
                  <View style={[
                    ...
                    {
                      height: barH,
                      backgroundColor: isToday ? C.white : "rgba(255,255,255,0.35)",
                    }
                  ]} />
        ...
        {tab === "log" && (
          <>
              ...
              <View style={styles.moodRow}>
                {MOODS.map(m => (
                  ...
                  >
                    ...
                    <Text style={[
                      styles.moodLabel,
                      selectedMood === m.value && { color: m.color, fontWeight: "700" },
                    ]}>
                      {m.label}
                    </Text>
                  </TouchableOpacity>
                ...
                {FEELINGS.map(f => {
                  ...
                  return (
                    <TouchableOpacity
                      ...
                      style={[styles.feelingTag, selected && styles.feelingTagActive]}
                      activeOpacity={0.8}
                    >
                      <Text style={[styles.feelingTagText, selected && styles.feelingTagTextActive]}>
                        {f}
                      </Text>
                    </TouchableOpacity>
                  );
            ...
            <View style={styles.card}>
              ...
              <Text style={styles.cardSub}>Optional — what's on your mind?</Text>
              <TextInput
                value={note}
            ...
            >
              <Text style={styles.saveBtnText}>
                {saved ? "✓ Mood Logged! Taking you home..." : "Save & Continue"}
              </Text>
            </TouchableOpacity>
              ...
              return (
                <View key={i} style={styles.historyCard}>
                  <View style={styles.historyTop}>
                    ...
                    <View style={[styles.historyMoodBadge, { backgroundColor: `${mood.color}15` }]}>
...
const styles = StyleSheet.create({
  ...
  summaryCard:          { borderRadius: 24, padding: 20, marginBottom: 16, backgroundColor: C.primary },
  summaryWeekLabel:     { fontSize: 11, color: "rgba(255,255,255,0.75)", letterSpacing: 1, marginBottom: 4 },
  ...
  tab:                  { paddingHorizontal: 20, paddingVertical: 8, borderRadius: 99, borderWidth: 1.5, borderColor: C.border, backgroundColor: C.white },
  ...
  moodBtn:              { flex: 1, alignItems: "center", paddingVertical: 10, backgroundColor: C.primaryLight, borderRadius: 14, borderWidth: 2, borderColor: "transparent" },
  ...
  feelingTag:           { backgroundColor: C.primaryLight, borderRadius: 99, paddingHorizontal: 14, paddingVertical: 7 },
  ...
  noteInput:            { backgroundColor: C.primaryLight, borderRadius: 14, padding: 14, fontSize: 14, color: C.text, minHeight: 100, textAlignVertical: "top", borderWidth: 1.5, borderColor: C.border },
  saveBtn:              { backgroundColor: C.primary, borderRadius: 16, paddingVertical: 18, alignItems: "center", marginBottom: 12, shadowColor: C.primary, shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.35, shadowRadius: 12, elevation: 6 },
  ...
  savedConfirm:         { textAlign: "center", fontSize: 13, color: C.green, fontWeight: "600", marginBottom: 16 },
  historyCard:          { backgroundColor: C.white, borderRadius: 20, padding: 18, marginBottom: 14, shadowColor: C.primary, shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.06, shadowRadius: 12, elevation: 2 },
  ...
  historyMoodBadge:     { flexDirection: "row", alignItems: "center", gap: 6, borderRadius: 99, paddingHorizontal: 12, paddingVertical: 4 },
  historyMoodEmoji:     { fontSize: 16 },
  historyMoodLabel:     { fontSize: 13, fontWeight: "700" },
  historyTags:          { flexDirection: "row", flexWrap: "wrap", gap: 6, marginBottom: 10 },
  historyTag:           { backgroundColor: C.primaryLight, borderRadius: 99, paddingHorizontal: 10, paddingVertical: 3 },
  historyTagText:       { fontSize: 12, fontWeight: "600", color: C.primary },
  historyNoteWrap:      { borderTopWidth: 1, borderTopColor: C.border, paddingTop: 10 },
