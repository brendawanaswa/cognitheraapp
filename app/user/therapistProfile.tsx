...
import {
  ...
  StyleSheet, SafeAreaView, Modal, Alert, TextInput,
} from "react-native";
...
const THERAPISTS: Record<string, any> = {
  "1": {
    ...
    rating: 4.9, reviews: 124, price: "KES 8,500", experience: "11 years", available: true,
    sessions: ["Video call", "Voice call", "Text / Chat"],
    about: "I'm a warm, compassionate therapist who believes healing happens when you feel truly heard.",
    education: "PhD Clinical Psychology, University of Nairobi",
    languages: ["English", "Swahili"], responseTime: "Within 2 hours",
  },
  "2": {
    name: "Dr. Kwame Otieno",
    title: "Counselling Psychologist",
    specialties: ["Relationships", "Grief & Loss", "Self-Esteem"],
    rating: 4.7, reviews: 89, price: "KES 7,500", experience: "8 years", available: true,
    sessions: ["Video call", "Text / Chat"],
    about: "I specialize in helping people navigate complex relationships and life transitions.",
    education: "MSc Counselling Psychology, Kenyatta University",
    languages: ["English", "Swahili", "Luo"], responseTime: "Within 3 hours",
  },
  "3": {
    name: "Dr. Zawadi Muthoni",
    title: "Cognitive Behavioral Therapist",
    specialties: ["Anxiety & Panic", "OCD", "Self-Esteem"],
    rating: 4.8, reviews: 97, price: "KES 9,000", experience: "10 years", available: false,
    sessions: ["Video call", "Voice call"],
    about: "I use evidence-based CBT techniques to help clients challenge negative thought patterns.",
    education: "PhD Psychology, Strathmore University",
    languages: ["English", "Swahili", "Kikuyu"], responseTime: "Within 4 hours",
  },
  "4": {
    name: "Dr. Jabali Kamau",
    title: "Family & Marriage Therapist",
    specialties: ["Family Therapy", "Relationships", "Child & Adolescent"],
    rating: 4.6, reviews: 76, price: "KES 6,500", experience: "6 years", available: true,
    sessions: ["Video call", "Voice call", "Text / Chat"],
    about: "I work with families and couples to strengthen communication and resolve conflicts.",
    education: "MSc Family Therapy, USIU Africa",
    languages: ["English", "Swahili", "Kikuyu"], responseTime: "Within 2 hours",
  },
  "5": {
    name: "Dr. Imani Wanjiku",
    title: "Trauma & PTSD Specialist",
    specialties: ["Trauma & PTSD", "Depression", "Addiction"],
    rating: 4.9, reviews: 112, price: "KES 10,000", experience: "14 years", available: true,
    sessions: ["Video call", "Text / Chat"],
    about: "With over 14 years of experience, I specialize in trauma-informed care using EMDR.",
    education: "PhD Trauma Psychology, University of Nairobi",
    languages: ["English", "Swahili"], responseTime: "Within 1 hour",
  },
};
    ...
    <SafeAreaView style={styles.safe}>
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        <View style={styles.profileHeader}>
          ...
          <Text style={styles.titleText}>{therapist.title}</Text>
          ...
          <View style={styles.sessionTypes}>
            {therapist.sessions.map((s: string) => (
              ...
              >
                ...
                <Text style={[styles.sessionText, selectedSession === s && styles.sessionTextActive]}>{s}</Text>
              </TouchableOpacity>
            ))}
          </View>
          <TouchableOpacity
          ...
          <View style={styles.modalCard}>
            {!booked ? (
              <>
                ...
                <Text style={styles.modalSub}>{selectedSession} with {therapist.name}</Text>
                <TextInput
                  placeholder="Preferred Date (e.g. Apr 10, 2026)"
                ...
                <View style={styles.modalPriceRow}>
                  <Text style={styles.modalPriceLabel}>Session Fee:</Text>
                ...
                <TouchableOpacity onPress={() => setBookModal(false)} style={{ marginTop: 12 }}>
                  <Text style={{ textAlign: "center", color: "#6B7280", fontSize: 14 }}>Cancel</Text>
                </TouchableOpacity>
              </>
            ) : (
              <>
                ...
                <Text style={styles.modalSub}>Your {selectedSession} with {therapist.name} has been scheduled!</Text>
                <View style={styles.bookingDetails}>
                  <Text style={styles.bookingDetailText}>📅 {bookDate}</Text>
                  <Text style={styles.bookingDetailText}>🕐 {bookTime}</Text>
                  <Text style={styles.bookingDetailText}>💰 {therapist.price}</Text>
                  <Text style={styles.bookingDetailText}>
                    {selectedSession === "Video call" ? "🎥" : selectedSession === "Voice call" ? "📞" : "💬"} {selectedSession}
                  </Text>
                </View>
                <Text style={styles.bookingNote}>You will receive a confirmation before your session.</Text>
                <TouchableOpacity
                  style={styles.modalBtn}
                  onPress={() => { setBookModal(false); setBooked(false); setBookDate(""); setBookTime(""); }}
                >
...
const styles = StyleSheet.create({
  ...
  titleText:          { fontSize: 14, color: C.muted, marginBottom: 16 },
  ...
  modalInput:         { width: "100%", backgroundColor: "#F9FAFB", borderRadius: 12, padding: 14, fontSize: 15, borderWidth: 1.5, borderColor: "#E5E7EB", marginBottom: 12, color: "#1F1F1F" },
  modalPriceRow:      { flexDirection: "row", justifyContent: "space-between", alignItems: "center", width: "100%", marginBottom: 20, backgroundColor: "#F3F4F6", borderRadius: 12, padding: 14 },
  modalPriceLabel:    { fontSize: 14, color: "#6B7280", fontWeight: "600" },
  modalPrice:         { fontSize: 20, fontWeight: "800", color: C.primary },
  bookingDetails:     { width: "100%", backgroundColor: "#F0EEFF", borderRadius: 16, padding: 16, gap: 8, marginBottom: 16 },
  bookingDetailText:  { fontSize: 14, fontWeight: "600", color: "#1F1F1F" },
  bookingNote:        { fontSize: 13, color: "#6B7280", textAlign: "center", marginBottom: 20, lineHeight: 20 },
