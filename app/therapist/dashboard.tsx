...
const TODAY_SESSIONS = [
  { id: "1", client: "Sarah M.",   time: "09:00 AM", type: "Video call",  status: "upcoming",  avatar: "S" },
  { id: "2", client: "James K.",   time: "11:30 AM", type: "Voice call",  status: "upcoming",  avatar: "J" },
  { id: "3", client: "Priya R.",   time: "02:00 PM", type: "Video call",  status: "completed", avatar: "P" },
  { id: "4", client: "Michael T.", time: "04:30 PM", type: "Text / Chat", status: "upcoming",  avatar: "M" },
];

const NOTIFICATIONS = [
  { id: "1", text: "Sarah M. booked a session for tomorrow",   time: "2m ago", icon: "📅", unread: true },
  { id: "2", text: "James K. left you a 5 star review",        time: "1h ago", icon: "⭐", unread: true },
  { id: "3", text: "Your payment of KES 8,500 has been sent",  time: "3h ago", icon: "💰", unread: false },
  { id: "4", text: "Priya R. rescheduled her session",         time: "5h ago", icon: "🔄", unread: false },
];
  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      <View style={styles.nav}>
        ...
        <TouchableOpacity onPress={() => setNotifOpen(true)} style={styles.notifBtn}>
            ...
            <View style={styles.drawerProfile}>
              ...
              <View>
                ...
                <View style={[
                  ...
                  { backgroundColor: verified === "approved" ? `${C.green}18` : "#FEF3C7" }
                ]}>
                  <Text style={[
                    styles.verifiedText,
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.greetingCard}>
          <View>
            <Text style={styles.greetingText}>Good morning, Dr. {therapistName} 👋</Text>
            <Text style={styles.greetingSub}>
              You have {TODAY_SESSIONS.filter(s => s.status === "upcoming").length} sessions today
            </Text>
          </View>
          {verified === "pending" && (
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.statsScroll}>
          {[
            { label: "Total Earnings", value: "KES 124K", icon: "💰", color: C.primary },
            { label: "Sessions Today", value: "4",        icon: "📅", color: C.purple },
            ...
            {WEEK_STATS.map((d, i) => {
              ...
              return (
                <View key={d.day} style={styles.barCol}>
                  ...
                  <Text style={[styles.barDay, isToday && { color: C.primary, fontWeight: "700" }]}>
                    {d.day}
                  </Text>
                </View>
              );
...
const styles = StyleSheet.create({
  ...
  notifBadge:         { position: "absolute", top: 0, right: 0, width: 18, height: 18, borderRadius: 9, backgroundColor: C.red, alignItems: "center", justifyContent: "center" },
  ...
  drawerProfile:      { flexDirection: "row", alignItems: "center", gap: 12, padding: 16, backgroundColor: C.bg, borderRadius: 16, marginBottom: 20 },
  ...
  drawerName:         { fontSize: 15, fontWeight: "700", color: C.text, marginBottom: 4 },
  verifiedBadge:      { borderRadius: 99, paddingHorizontal: 10, paddingVertical: 3, alignSelf: "flex-start" },
  ...
  notifModal:         { backgroundColor: C.white, borderTopLeftRadius: 28, borderTopRightRadius: 28, padding: 24 },
  ...
  notifItem:          { flexDirection: "row", alignItems: "center", gap: 12, paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: C.border },
  notifItemUnread:    { backgroundColor: C.primaryLight, borderRadius: 12, paddingHorizontal: 10 },
  ...
  greetingCard:       { backgroundColor: C.primary, borderRadius: 20, padding: 20, marginBottom: 16, flexDirection: "row", justifyContent: "space-between", alignItems: "center" },
  greetingText:       { fontSize: 18, fontWeight: "800", color: C.white, marginBottom: 4 },
  greetingSub:        { fontSize: 13, color: "rgba(255,255,255,0.75)" },
  pendingTag:         { backgroundColor: "#FEF3C7", borderRadius: 99, paddingHorizontal: 12, paddingVertical: 6 },
  pendingTagText:     { fontSize: 12, fontWeight: "700", color: C.yellow },
  statsScroll:        { marginBottom: 16 },
  statCard:           { backgroundColor: C.white, borderRadius: 16, padding: 16, marginRight: 10, width: 130, borderTopWidth: 3, shadowColor: "#000", shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.05, shadowRadius: 8, elevation: 2 },
  ...
  sessionItem:        { flexDirection: "row", alignItems: "center", gap: 12, paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: C.border },
  sessionAvatar:      { width: 40, height: 40, borderRadius: 20, backgroundColor: C.primaryLight, alignItems: "center", justifyContent: "center" },
  ...
  joinBtn:            { backgroundColor: C.primary, borderRadius: 10, paddingVertical: 6, paddingHorizontal: 14 },
  joinBtnText:        { fontSize: 13, fontWeight: "700", color: C.white },
  completedTag:       { backgroundColor: `${C.green}18`, borderRadius: 10, paddingVertical: 6, paddingHorizontal: 14 },
  completedTagText:   { fontSize: 13, fontWeight: "700", color: C.green },
  barChart:           { flexDirection: "row", alignItems: "flex-end", gap: 6, height: 110, marginBottom: 16 },
  ...
  metricCard:         { flex: 1, backgroundColor: C.bg, borderRadius: 14, padding: 14, alignItems: "center" },
  metricValue:        { fontSize: 20, fontWeight: "800", marginBottom: 4 },
  metricLabel:        { fontSize: 11, color: C.muted, textAlign: "center", fontWeight: "600" },
  clientItem:         { flexDirection: "row", alignItems: "center", gap: 12, paddingVertical: 10, borderBottomWidth: 1, borderBottomColor: C.border },
  clientAvatar:       { width: 40, height: 40, borderRadius: 20, backgroundColor: C.purpleLight, alignItems: "center", justifyContent: "center" },
